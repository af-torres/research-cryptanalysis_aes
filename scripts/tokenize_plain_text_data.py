...
d_config = dict(
    ...
    mini_aes = dict(
        plain_text_dir = "./data/plain_text/mini_aes",
        data_name = "mini_aes"
    ),
)
...
unique_letters = get_unique_tokens(p_set, col="text")
...
if args.reduced_char_set or USE_MINI_AES_ENC:
    reduced_vocab = get_unique_tokens(p_tokens)
